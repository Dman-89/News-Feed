...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class NewsPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference articlesToShow = findPreference(getString(R.string.settings_articles_to_display_key));
            bindPreferenceSummaryToValue(articlesToShow);
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            // here preference summary is updated
        ...
        private void bindPreferenceSummaryToValue(Preference preference) {
            // use setOnPreferenceChangeListener to set the current
            // EarthquakePreferenceFragment instance to listen for changes in preference
